...
refTechData = [50.0 * 12 / 1000.0, 18000, 13500, 1.03, 0.99999, 8.0*1e6] # CLC ($/kW/m), INV ($/PHa, ~$18/TH Bitmain S21 XP per HashrateIndex May 2026), POW (W/PHa, 13.5 J/TH Bitmain S21 XP), PUE (dimensionless), UTZ (dimensionless), NRE ($)
