...
refMktData = [80000, 164250, 3*365, 1000000, 3] # BTC Price ($), Annual supply (BTC/yr at 3.125 BTC/block), Annual fees (BTC/yr, ~3 BTC/day on-chain May 2026), Network hashrate (PHa, ~1000 EH/s), Amortization (years)
