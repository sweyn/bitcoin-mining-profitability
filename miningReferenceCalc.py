...
refTechData = [40.0 * 12 / 1000.0, 18000, 13500, 1.03, 0.99999, 8.0*1e6] # CLC ($/kW/m, $40/kW/mo = $0.055/kWh competitive industrial rate per OneMiners/D-Central May 2026), INV ($/PHa, ~$18/TH Bitmain S21 XP per HashrateIndex May 2026), POW (W/PHa, 13.5 J/TH Bitmain S21 XP), PUE (dimensionless), UTZ (dimensionless), NRE ($)

refMktData = [78000, 164250, 3*365, 960000, 3] # BTC Price ($, ~$77,900 per CoinGecko/CoinMarketCap May 16 2026), Annual supply (BTC/yr at 3.125 BTC/block), Annual fees (BTC/yr, ~3 BTC/day on-chain May 2026), Network hashrate (PHa, 935-994 EH/s per CoinWarz/Minerstat May 2026), Amortization (years)
