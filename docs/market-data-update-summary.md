...
|----------|------------|-----------------|
| h* (optimal total hashrate) | 759 PHa | 911,045 PHa (911 EH/s) |
...
With current parameters, the analytical optimum h* ≈ 911 EH/s falls below the current network hashrate h₀ = 1,000 EH/s. This means:
